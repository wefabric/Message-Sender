...
class MessageResponse extends AbstractStructBase
{
     ...
     */
    protected ?\Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\Message $Message = null;
    /**
     ...
     * @param \Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\Message $message
     */
    public function __construct(bool $messageResult, ?\Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\Message $message = null)
    {
        $this
     ...
     */
    public function getMessage(): ?\Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\Message
    {
        return $this->Message;
    }
    /**
     ...
     * @return \Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\MessageResponse
     */
    public function setMessage(?\Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\Message $message = null): self
    {

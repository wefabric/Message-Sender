...
class CustomInfoType extends AbstractStructBase
{
     ...
     */
    public function __construct(bool $isTestMessage, ?string $languageCode = null, ?bool $isContentCompressed, ?string $applicationId, ?string $versionId, ?string $relationId)
    {
        $this
     ...
     * @param bool $isTestMessage
     * @return \Wefabric\MessageSender\MessageService31_TechnischeUnie\StructType\CustomInfoType
     */
